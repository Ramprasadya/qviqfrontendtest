...
import { HiChevronDoubleLeft, HiChevronLeft, HiOutlineX } from "react-icons/hi";
...
function Modal(props) {props = useDefaultProps(props);
  return (
    <div className="container" style={{ zIndex: "998", width: props.width }}>
      <div className="modal-wrapper" style={{ zIndex: "998" }}></div>

      <div
        className="flex flex-col modal-container min-w-full md:min-w-fit md:w-[90vw] xl:w-[70vw] h-fit pb-[20px] !top-auto !bottom-0 md:!bottom-auto md:!top-1/2"
        style={{ zIndex: "998" }}
      >
        ...
        <div className="mx-5 md:mx-6 border-t h-fit overflow-auto ">
          {props.children}
        </div>
      </div>
    </div>
