...
const Template29 = (props) => {
  // Button Component Styling
  const buttonStyle =
    "bg-[#FFFFFF] text-[#121212] rounded-full border-r-[6px] border-b-[6px] border-[#636363] DM-Sans-font-div hover:border-none hover:cursor-pointer h-[56px] w-[262px]";
  ...
  const appsStyle = {
    ...
    app: `w-[132px] h-[132px] rounded-[30px] flex items-center justify-center backdrop-blur-[5px] ${props.mainfg}`,
  ...
  // Heading Section
  const headerStyle = {
    div: "rounded-[100px] border-[4px] border-[#636363] bg-[#FFFFFF] text-[#121212] DM-Sans-font-div",
  ...
  const productStyle = {
    card: "min-w-[280px] max-w-[280px]  max-h-full p-[10px] rounded-[16px] bg-[#272727] text-[#121212] DM-Sans-font-div flex flex-col item-start gap-4",
    image: "w-[280px] h-[280px] rounded-[16px]",
    title: "text-[22px] font-bold text-[#ffffffEc]",
    description: "text-base text-[#ffffffEc] break-words",
    price: "text-[16px] font-bold text-[#ffffffEc]",
  };

  // Services Section
  const serviceStyle = {
    card: "flex flex-col justify-start items-center min-w-[280px] max-w-[280px] min-h-[280px] max-h-full p-6 rounded-[16px] text-[#121212] DM-Sans-font-div gap-4 bg-[#272727]",
    image: "w-[64px] h-[64px] rounded-[12px]",
    title: "text-base font-bold text-[#ffffffEc] break-words",
    description: "text-base text-[#ffffffEc] break-words",
  };
  ...
  const resourceStyle = {
    ...
    wordlimit: 25,
    card: "flex items-center h-[72px] px-6 border-r-[8px] border-b-[8px] border-[#636363] rounded-full bg-[#FFFFFfDc] DM-Sans-font-div hover:border-none duration-200 hover:cursor-pointer",
  ...
  const businessHoursStyle = {
    div: "flex flex-col justify-center items-center w-[582px] bg-[#FFFFFF] text-[#121212] rounded-[40px] p-10 DM-Sans-font-div relative",
    title: "text-xl font-bold mb-5 text-[#ffffffDf]",
    time: "text-base text-[#ffffffDf]",
  ...
  // Reviews Section
  const reviewStyle = {
    card: " flex flex-col justify-center items-center rounded-[20px] text-[#121212] border-[3px] border-[#121212] min-w-[381px] max-w-[381px] min-h-full max-h-full flex flex-col gap-4 p-6",
    starColor: "white",
  ...
  // Gallery Section
  const galleryStyle = {
    heading: "text-[32px] font-bold text-[#ffffff] DM-Sans-font-div mb-[45px]",
    image: `w-[300px] h-[300px] lg:w-[380px] lg:h-[380px] rounded-[20px] bg-[#cccccc]`,
  };

  // Contact Us Button
  const contactBtnStyle =
    "flex items-center justify-center gap-2 px-4 h-[80px] bg-[rgba(255,255,255,0.50)] border border-[#FFFFFF] shadow-[0px_8px_20px_0px_rgba(18,18,18,0.32)] rounded-full backdrop-blur-[10px] text-[16px] font-bold DM-Sans-font-div text-[#121212] z-[100] hover:cursor-pointer";
  const innerBtnStyle = {
