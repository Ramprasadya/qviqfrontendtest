...
import BaseTemplate3 from "../ProfileComponents/BaseTemplates/BaseTemplate3";
...
const Template11 = (props) => {
  ...
  const appsStyle = {
    ...
    app: `w-[132px] h-[132px] rounded-[30px] flex items-center justify-center ${props.mainfg} backdrop-blur-[5px]`,
  ...
  const productStyle = {
    card: "min-w-[280px] max-w-[280px] h-fit max-h-full rounded-[16px] bg-transparent text-[#121212] DM-Sans-font-div flex flex-col item-start gap-4",
  ...
  const contactBtnStyle =
    "flex items-center justify-center gap-2 px-4 h-[80px] bg-[rgba(255,255,255,0.50)] border border-[#FFFFFF] shadow-[0px_8px_20px_0px_rgba(18,18,18,0.32)] hover:shadow-none rounded-[20px] backdrop-blur-[10px] text-[16px] font-bold DM-Sans-font-div text-[#121212] z-[100] hover:cursor-pointer";
  const innerBtnStyle = {
