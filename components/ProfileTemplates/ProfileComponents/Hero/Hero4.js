...
const Hero4 = (props) => {
  ...
  return (
    <div
      className='max-w-[1182px] py-[50px] px-5 flex flex-col justify-center items-center relative rounded-[40px] backdrop-blur-[5px] DM-Sans-font-div' style={{background: 'linear-gradient(180deg, #033CCE, transparent)',  boxShadow: '0px 12px 40px 1px rgba(3, 60, 206, 0.10)'}}>
