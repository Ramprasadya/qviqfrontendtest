...
import Reviews3 from "../Reviews/Reviews3";
                ...
                <div className="mt-[72px] px-[121px] flex flex-col justify-start items-center gap-[16px]">
                  {customLinks.map((site, index) => {
                    return dummyData ? (
                      ...
                      <div
                        className={`min-h-[56px] w-[100%] ${
                          site.isChecked && site.animation
                        } min-w-[320px] p-[12px] rounded-[12px] bg-white flex flex-row justify-start items-center gap-[12px]`}
                        style={{
                          boxShadow: "4px 4px 0px 0px #000",
                          borderRadius: "12px",
                          border: "1px solid #121212",
                ...
                <div className="mt-[48px]">
                  ...
                  {availabilitySwitch &&
                    ...
                    availabilityArr.length !== 0 && (
                      <div
                        className={`w-full  mb-[20px] flex flex-col backdrop-blur-[18px] rounded-[20px]`}
                        ref={appointmentsRef}
                        id="appointments"
                      >
