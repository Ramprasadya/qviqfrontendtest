...
import Reviews4 from "../Reviews/Reviews4";
import { RiQuillPenLine } from "react-icons/ri";
import Button from "../Button/Button";
import Bottom4 from "../../template1/Bottom4";
import Products4 from "../Products/Products4";
                ...
                <div className="mt-12">
                  ...
                  {availabilitySwitch &&
                    ...
                    availabilityArr.length !== 0 && (
                      <div
                        className={`w-full  mb-[20px] flex flex-col backdrop-blur-[18px] rounded-[20px] border border-[#FFF]`}
                        ref={appointmentsRef}
                        id="appointments"
                      >
