...
import CustomHero1 from "../Hero/CustomHero1";
          ...
          >
            <div>
              ...
              >
                ...
                <div
                  className="z-[0] absolute h-[97.5%] w-[98.8%] rounded-[37px] backdrop-blur-[5px]"
              ...
              {customLinks.length != 0 && (
                <div className="px-[121px] mt-[8rem] flex flex-col justify-start items-center gap-[16px]">
                    ...
                    return dummyData ? (
                      site.customLinkImage ? (
                        ...
                        <div
                          ...
                          } min-h-[56px] w-[100%] min-w-[320px] p-[12px] rounded-[12px] bg-white flex flex-row justify-center items-center gap-[12px]`}
                          style={{
                            boxShadow: "4px 4px 0px 0px #000",
                            border: "1px solid #121212",
                            objectFit: "cover",
                ...
                <div className="mt-12">
                  ...
                  {activeComponent === reviewLabel && (
                    <CustomReviews
                      ...
                      templatebg={templatebg}
                      customBtn={props.customBtn}
                      buttonStyle={buttonStyle.concat("min-w-[320px] mx-auto")}
                      scrollBtn={scrollBtn}
            ...
            {availabilitySwitch &&
              ...
              availabilityArr.length !== 0 && (
                <div
                  className={`w-full mb-[20px] flex flex-col backdrop-blur-[18px] bg-[rgba(0,0,0,0.20)] `}
                  ref={appointmentsRef}
                  id="appointments"
                >
            ...
            {reviewButtonSwitch && (
              <div
                className="w-full h-[60px] flex flex-row justify-center"
                id={`${reviewsArr.length == 0 ? "reviews" : ""}`}
              >
                <CustomButton
                  text="Write a review"
                  icon={<RiQuillPenLine />}
                  style={buttonStyle.concat(" min-w-[320px] mx-auto h-[56px]")}
                  customBtn={props.customBtn}
                  onClick={() => {
                    !dummyData && setReviewOpen(true);
                  }}
