      ...
      <div className="relative">
        <div className="overflow-scroll" ref={reviewRef}>
          <div className="flex flex-row gap-5 py-[10px]">
            {data.map((item, index) => {
              return (
                <div className={`relative ${style.card}`} style={{boxShadow: '0px 8px 16px 1px rgba(3, 60, 206, 0.04), 0px 0px 8px 1px rgba(3, 60, 206, 0.08)'}} key={index}>
