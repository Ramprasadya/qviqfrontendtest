  ...
  return (
    <div className={`flex flex-col justify-center items-center`}>
      <div className={`${style.div}`}>
        ...
        <div
          className={`absolute top-[-4px] right-[-4px] rounded-bl-[16px]`}
          style={{
            background: props.templatebg,
          }}
        >
          <div className="w-0 h-0 border-l-[70px] border-l-[#121212] border-t-[70px] border-t-transparent rounded-bl-[16px]" />
        </div>
      </div>
    </div>
  );
