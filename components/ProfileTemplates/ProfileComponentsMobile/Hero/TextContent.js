  ...
  return (
    <div className="flex flex-col gap-3 max-w-[700px]">
     ...
     {!dummy
        ? data.mobileNumber !== "" && (
            ...
            onClick={handleShowMobile}
              className=" inline-flex justify-center gap-1 hover:cursor-pointer w-[100px]  h-[47px] rounded-[8px] bg-[rgba(255,255,255,0.16)]"
     ...
     {!dummy 
        ? data.email !== "" && (
            <p
              className="inline-flex justify-center gap-1 hover:cursor-pointer w-[100px] h-[47px] rounded-[8px] bg-[rgba(255,255,255,0.16)]  break-all"
              style={props.titleStyle}
            >
              <span
              ...
              >
                ...
                <p className="ml-2 w-[41px] h-[19px] text-[14px] font-[600]">Email </p>
              </span>
            </p>
          )
        : ""}
