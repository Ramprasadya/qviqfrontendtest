...
const Appointments2 = (props) => {
  ...
  return (
    <div className={`flex flex-col ${style.div}  `}>
      <h4 className={`mb-3 ${style.heading} flex justify-center `}>
          ...
          <div className="flex gap-2 min-w-fit h-[44px]">
            {dateArr[activeIndex2]?.slots?.map((item, index) => {
              return (
                <div
                  key={index}
                  className={`w-[120px]  h-[42px] py-[12px] px-[16px] gap-1 select-none flex justify-center items-center rounded-[8px] 
                  ${
      ...
      <div className="mt-[20px] flex flex-col items-center">
        <div className="flex flex-col gap-[14px] w-full max-w-[388px]">
          <div>
          ...
          <div className="w-full flex justify-center h-[50px]">
            {props.btnType == "custom" ? (
              ...
              <Button
                ...
                style={props.buttonStyle.concat(" !w-fit")}
                onClick={handleSubmit}
                text={"Submit"}
              />
            )}
