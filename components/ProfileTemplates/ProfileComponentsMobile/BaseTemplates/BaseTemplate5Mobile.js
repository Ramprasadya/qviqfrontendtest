...
import Reviews5 from "../../ProfileComponents/Reviews/Reviews5";
...
import Products5 from "../../ProfileComponents/Products/Products5";
...
const BaseTemplate5Mobile = (props) => {
  const {
    dummyState,
    setDummyState,
    quickSelectContext,
        ...
        <>
          {!quickSelect && fromIphone && dummyLeadCapture ? (
            ...
            <div className="max-w-[1182px] w-full">
              ...
              >
                <div>
                  {/* <Hero4 heroData={heroData} heroStyle={heroStyle} /> */}
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, #033CCE, transparent)",
                      boxShadow: "0px 12px 40px 1px rgba(3, 60, 206, 0.10)",
                    }}
                  >
                    <div className="z-[5] w-[120px] h-[120px] mb-[4px]">
                      <img
                        src={heroData.profilePic}
                        alt="logo"
                        className={`w-[120px] h-[120px] border border-[#FFF] object-cover ${heroStyle.profilePic}`}
                      />
                    </div>
                    ...
                    <div className="w-full min-h-[100px] flex flex-row justify-center">
                      <ContactBtn
                          ...
                          site.customLinkImage ? (
                            <div
                              ...
                              style={{
                                ...
                                boxShadow:
                                  "0px 0px 8px 1px rgba(3, 60, 206, 0.08)",
                              }}
                              key={index}
                            >
                              <img
...
export default BaseTemplate5Mobile;
