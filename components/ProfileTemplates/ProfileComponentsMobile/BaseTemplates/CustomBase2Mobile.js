...
import CustomBottom2 from "../../template1Mobile/CustomBottom2";
      ...
      {!dummyData && quickSelect && appsArr.length !== 0 ? (
        ...
        <>
          {!quickSelect && fromIphone && dummyLeadCapture ? (
            ...
            // w-full max-w-[768px] min-h-[100vh] box-border flex flex-col items-center justify-start
            <div
              id="scroller"
              className=" w-full max-w-[768px] h-[100vh] overflow-y-auto box-border flex flex-col items-center justify-start"
              ref={templateRef}
              style={mainbg}
            >
              <div className="w-full flex flex-col items-center justify-center mt-[92px] px-[20px]">
                <div className={`flex flex-col gap-3 w-[100%] `}>
                  <div
                    className={`w-[100%] min-h-[242px] mb-[12px] xsm2:min-h-[270px] flex flex-col items-center relative ${heroStyle.div}`}
                  >
                    ...
                    <div className="w-full pt-20 px-4 xsm2:px-8 text-center">
                      <p className={`mb-1 ${heroStyle.fullName}`} style={{color:props.customTextColor}}>
                        {herodata.fullName}
                      </p>
                      <p className={`mb-1 ${heroStyle.jobTitle}`} style={{color:props.customTextColor}}>
                        {herodata.jobTitle}
                      </p>
                      <p className={`mb-1 ${heroStyle.jobTitle}`} style={{color:props.customTextColor}}>
                        {herodata.companyName}
                      </p>
                      <p className={`mb-5 ${heroStyle.jobDescription}`} style={{color:props.customTextColor}}>
                ...
                {/* //  ${ 
                  ...
                  //      ? "w-[calc(100%-40px)]"
                  //      : "w-[calc(100%-20px)]"
                  //  } my-3 px-5 py-8 flex flex-col ${bodyStyle}`} */}
...
export default CustomBase2Mobile;
