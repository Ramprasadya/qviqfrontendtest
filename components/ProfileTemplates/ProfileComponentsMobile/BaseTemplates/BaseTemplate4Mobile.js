...
import ReviewModal4 from "../../template1/modals/ReviewModal4";
...
import Apps3 from "../Apps/Apps3";
import Gallery4 from "../Gallery/Gallery4";
import BusinessHours4 from "../BusinessHours/BusinessHours4";
import Reviews4 from "../../ProfileComponents/Reviews/Reviews4";
import IphoneExchangeContact from "../../template1/modals/IphoneExchangeContact";
import { RiQuillPenLine } from "react-icons/ri";
import Button from "../Button/Button";
import Bottom4 from "../../template1Mobile/Bottom4";
import Products4 from "../../ProfileComponents/Products/Products4";
...
import Appointments3 from "../../ProfileComponents/Appoinments/Appointments3";
...
const BaseTemplate4Mobile = (props) => {
  // all profile data
  const {
    dummyState,
    setDummyState,
  ...
  return (
    <div
      className={`w-full min-h-full flex flex-col items-center bg-[${templatebg}]`}
      ref={templateRef}
    >
        ...
        <>
          {!quickSelect && fromIphone && dummyLeadCapture ? (
            ...
            <div className="max-w-[1182px] w-full">
              <div
                className="flex flex-col gap-[48px] py-[40px] px-5 w-full"
                style={{ background: templatebg }}
              >
                <div>
                  {/* <Hero3 heroData={heroData} heroStyle={heroStyle} /> */}
                  <div
                  ...
                  >
                    <div className="z-[5] w-[120px] h-[120px] mb-[20px] ">
                      <img
                        ...
                        alt="logo"
                        className={`w-[120px] h-[120px] object-cover ${heroStyle.profilePic} border border-[linear-gradient(180deg, #FFFFFF 0%, #FFFFFF 100%)]`}
                      />
                    </div>
                    ...
                    <div
                      className={`${heroStyle.div} z-[0] absolute h-[97.5%] w-[97.8%] rounded-[28px] backdrop-blur-[5px]`}
                    ></div>

                    <div className="w-[100%] min-h-[100px] px-[10px] flex flex-col items-center">
                      <ContactBtn
                      ...
                      {customLinks.map((site, index) => {
                        return dummyData ? (
                          site.customLinkImage ? (
                            <div
                              className="min-h-[56px] w-[100%] p-[12px] bg-white flex flex-row justify-start items-center gap-[12px]"
                              style={{
                                cursor: "pointer",
                                objectFit: "cover",
                                borderRadius: "100px",
                                border: "1px solid #636363",
                                boxShadow: "2px 2px 0px 0px #636363",
                              }}
                              key={index}
                            >
                              <img
                            ...
                            <div
                              className="min-h-[56px] w-[100%] p-[12px] bg-white flex flex-row justify-center items-center gap-[12px]"
                              style={{
                                cursor: "pointer",
                                objectFit: "cover",
                                borderRadius: "100px",
                          ...
                          <div
                            ...
                            } min-h-[56px] w-[100%] p-[12px] bg-white flex flex-row justify-start items-center gap-[12px]`}
                            style={{
                              cursor: "pointer",
                              objectFit: "cover",
                              borderRadius: "100px",
                    ...
                    <div className="mt-12">
                      ...
                      {availabilitySwitch &&
                        ...
                        availabilityArr.length !== 0 && (
                          <div
                            className="w-full mb-[20px] rounded-[20px] border border-[#FFF] overflow-hidden"
                            ref={appointmentsRef}
                            id="appointments"
                          >
                    ...
                    >
                      ...
                      {activeComponent === reviewLabel && (
                        <Reviews4
                          ...
                          templatebg={templatebg}
                          buttonStyle={buttonStyle.concat(
                            " min-w-full mx-auto rounded-full"
                          )}
                          scrollBtn={scrollBtn}
                ...
                <Bottom4
                  ...
                  buttonStyle={buttonStyle.concat(" min-w-fit rounded-full")}
                  position={templatePosition}
                  dummy={dummyData}
...
export default BaseTemplate4Mobile;
