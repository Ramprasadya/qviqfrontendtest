...
import CustomBottom from "../../template1Mobile/CustomBottom";
...
import CustomApps1 from "../Apps/CustomApps1";
import Gallery3 from "../Gallery/Gallery3";
import BusinessHours3 from "../BusinessHours/BusinessHours3";
import CustomReviews from "../../ProfileComponents/Reviews/CustomReviews";
import IphoneExchangeContact from "../../template1/modals/IphoneExchangeContact";
import { RiQuillPenLine } from "react-icons/ri";
import CustomButton from "../Button/CustomButton";
import CustomProducts1 from "../../ProfileComponents/Products/CustomProducts1";
...
const CustomBase1Mobile = (props) => {
  ...
  // const hideBrand = props.hideBrand;
  // console.log(hideBrand);
  ...
  const customLinks = dummyData
    ...
    ? data.customLinks !== undefined
      ...
      : []
    : [];
  const appsArr = [...appsArrTemp, ...customLinks];
          ...
          {!quickSelect && fromIphone && dummyLeadCapture ? (
            <div>
              <IphoneExchangeContact
                background={heroStyle.background}
            ...
            <div className="max-w-[1182px] w-full min-h-[100vh] box-border flex flex-col items-center justify-start">
              <div
                className="flex flex-col gap-[48px] py-[40px] px-5 w-full h-[100%]"
                // style={{ background: templatebg }}
              >
                <div>
                  {/* <CustomHero1 heroData={heroData} heroStyle={heroStyle} /> */}
                  <div
                    className="max-w-[1182px] py-[20px] px-5 flex flex-col justify-center items-center relative rounded-[30px] backdrop-blur-[5px] DM-Sans-font-div"
                    style={{
                      background:
                        "linear-gradient(180deg, rgba(255, 255, 255, 0.64), transparent)",
                    }}
                  >
                    <div className="z-[5] w-[120px] h-[120px] mb-[20px]">
                      <img
                    ...
                    <div
                      className={`z-[5] flex flex-col gap-1 text-center w-full max-w-[760px]  `}
                      
                    >
                      <h1 className={`${heroStyle.fullName}`} style={{color:props.customTextColor}} >
                        {heroData.firstName + " " + (heroData.lastName || "")}
                      </h1>
                      <h4 className={`${heroStyle.jobTitle}`} style={{color:props.customTextColor}}>
                        {heroData.jobTitle}
                      </h4>
                      <h4 className={`${heroStyle.jobTitle}`} style={{color:props.customTextColor}}>
                        {heroData.companyName}
                      </h4>
                      <p className={`${heroStyle.jobDescription}`} style={{color:props.customTextColor}}>
                        {heroData.jobDescription}
                      </p>
                    </div>

                    <div
                      className="z-[0] absolute h-[97.5%] w-[97.8%] rounded-[28px] backdrop-blur-[5px]"
                      style={{ background: `${heroStyle.div}` }}
                    ></div>
                    {
                  ...
                  {customLinks.length != 0 && (
                    <div className="mt-[72px] flex flex-col justify-start items-center gap-[16px]">
                      {customLinks.map((site, index) => {
                        return dummyData ? (
                          site.customLinkImage ? (
                            ...
                            <div
                              className="min-h-[56px] w-[100%] p-[12px] rounded-[12px] bg-white flex flex-row justify-center items-center gap-[12px]"
                              style={{
                                boxShadow: "4px 4px 0px 0px #000",
                                border: "1px solid #121212",
                                objectFit: "cover",
                ...
                {headingsArr.length != 0 && (
                  <div>
                    <div
                      className={`w-full flex justify-center items-center relative px-5 ${headerStyle.div}`}
                    >
                ...
                {availabilitySwitch &&
                  ...
                  availabilityArr.length !== 0 && (
                    <div
                      className="w-full backdrop-blur-[18px] bg-[rgba(0,0,0,0.20)] mb-[20px]"
                      ref={appointmentsRef}
                      id="appointments"
                    >
                ...
                {reviewButtonSwitch && (
                  <div
                    className="mt-10 w-full h-[56px] flex flex-row justify-center"
                    id={`${reviewsArr.length == 0 ? "reviews" : ""}`}
                  >
                    <CustomButton
                      text="Write a review"
                      icon={<RiQuillPenLine />}
                      style={buttonStyle.concat(" min-w-full mx-auto h-[56px]")}
                      customBtn={props.customBtn}
                      onClick={() => {
                        !dummyData && setReviewOpen(true);
                      }}
                ...
                {data?.googleReviewButtonSwitch && (
                  ...
                  >
                    <CustomButton
                      ...
                      customBtn={props.customBtn}
                      onClick={() => {
                        !dummyData && setgoogleReviewOpen(true);
                      }}
                    />
                    {/* <div className="text-left">
                      <button className="float-end" onClick={()=>handleShareSpecific("reviews")}><RiShareBoxFill /></button>
...
export default CustomBase1Mobile;
