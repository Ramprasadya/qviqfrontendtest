...
const BaseTemplate1Mobile = (props) => {
  const {
    dummyState,
    setDummyState,
    quickSelectContext,
  ...
  const profileStyle = props.heroStyle.profile;
  ...
  const headingData = {
    ...
    // appointments: availabilitySwitch &&  availabilityArr && availabilityArr.length !== 0,
  ...
  return (
    <div
      className="w-full max-w-[768px] flex flex-col items-center justify-center"
      ref={templateRef}
      style={{ backgroundColor: heroStyle.background }}
    >
      {!dummyData && quickSelect && appsArr.length !== 0 ? (
        <div className="w-full min-h-full flex justify-center relative items-center bg-white">
        ...
        <>
          {!quickSelect && fromIphone && dummyLeadCapture ? (
            ...
            <>
              ...
              <div
                className="w-full flex flex-row justify-center pb-[10px]"
                style={{
              ...
              >
                {customLinks.length != 0 && (
                  <div className="px-[12px] flex flex-col justify-start items-center gap-[16px]">
                      ...
                      return dummyData ? (
                        site.customLinkImage ? (
                          ...
                          <div
                            ...
                            } min-h-[56px] w-[100%]  p-[12px] bg-white flex flex-row justify-center items-center gap-[12px]`}
                            style={{
                              ...props.customLinkStyle.linkBg,
                              objectFit: "cover",
                              cursor: "pointer",
                        ...
                        >
                          ...
                          />
                          <p
                            className={`text-[14px] font-[500] ${props.customLinkStyle.linkFont}`}
                          >
                            {site.label}
                          </p>
                        </div>
                ...
                {((productSwitch && productArr.length !== 0) ||
                  ...
                  <div
                    ...
                    style={{ background: templatebg }}
                  >
                    <div className="max-w-[1182px] w-full flex flex-col gap-16">
                      {productSwitch && productArr.length !== 0 && (
                ...
                <div
                  ...
                  style={{ background: templatebg }}
                >
                  <div className="max-w-[1182px] w-full flex flex-col gap-16 px-5">
                    {galleryArr.length !== 0 && (
                    ...
                    {reviewButtonSwitch || data?.googleReviewButtonSwitch && (
              ...
              {showToast && (
                <div
                  className={`flex justify-center items-center fixed bottom-10 left-[${templatePosition.left}]`}
                  style={{
                    zIndex: "999",
                    maxWidth: `${templatePosition.width - 40}px`,
                  }}
                >
                  <Toast
                    text={toastMessage}
...
export default BaseTemplate1Mobile;
