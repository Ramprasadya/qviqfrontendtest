...
import Reviews3 from "../../ProfileComponents/Reviews/Reviews3";
...
const BaseTemplate3Mobile = (props) => {
  // all profile data
  const {
    dummyState,
    setDummyState,
                  ...
                  >
                    <div className="z-[5] w-[120px] h-[120px] mb-[20px]">
                      <img
                        ...
                        alt="logo"
                        className={`w-[120px] h-[120px] border border-[linear-gradient(180deg, #FFFFFF 0%, #FFFFFF 100%)] object-cover ${heroStyle.profilePic}`}
                      />
                    </div>
                    ...
                    <div className="mt-[24px]">
                      ...
                      {availabilitySwitch &&
                        ...
                        availabilityArr.length !== 0 && (
                          <div
                            className={`w-full  mb-[20px] flex flex-col backdrop-blur-[18px] rounded-[20px] overflow-hidden`}
                            ref={appointmentsRef}
                            id="appointments"
                          >
...
export default BaseTemplate3Mobile;
