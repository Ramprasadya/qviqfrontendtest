...
// import CustomButton from "../ProfileComponents/CustomButton/CustomButton";
import { clientUrl } from "../../../config";
import CustomButton from "../ProfileComponents/Button/CustomButton";
...
export default function CustomBottom2(props) {props = useDefaultProps(props);
  const style = {
    width: props.width,
  ...
  return (
    !props.logoSwitch && (
      <div className={`w-full ${props.mainFontFamily}-font-div`} style={style}>
        <div
          className={`p-5 w-full rounded-[16px] flex bg-white sm:p-6 sm:justify-between sm:items-center flex-col sm:flex-row relative overflow-hidden text-[#121212] ${props.style}`}
        >
          <Image alt="logo" 
