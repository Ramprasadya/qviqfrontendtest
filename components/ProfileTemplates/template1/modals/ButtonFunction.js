...
export default function ButtonFunction(props) {
    ...
    await fetch(
      ...
      .then((data) => {
        if (data.error) {
          ...
          props.setToastMessage("Contact Saved Successfullyy");
          props.setShowToast(true);
        }
      });
  ...
  return (
    ...
    >
      <div
        className="modal-wrapper bg-[#00000054] backdrop-blur-lg"
        style={{ zIndex: "998" }}
      ></div>
      <div
      ...
      >
        <div className="flex flex-col gap-6 items-end w-[230px]">
          {buttonArr.map((item, index) => {
            return (props.mobileVisibility === null ||
              ...
              <div
                ...
                key={index}
                style={{ position: "static", ...props.customBtnStyle }}
              >
