  ...
  return (
    <div className="container" style={{ zIndex: "998" }}>
      ...
      <div
        ...
        style={{ zIndex: "998", height: "fit-content", background: "#272727" }}
      >
        <div className="flex justify-between items-center px-3 py-4 xsm:px-5 md:p-4">
          <p className="text-lg text-white md:text-xl tracking-normal font-semibold">
            Write a Review
          </p>
          <span
        ...
        <div className="mx-3 xsm:mx-5 md:mx-6   ">
          <div
            ...
            style={{
              background:
                "linear-gradient(82deg, rgba(255, 255, 255, 0.20) 2.06%, rgba(255, 255, 255, 0.03) 96.8%)",
            }}
          >
            {hover === -1 ? (
            ...
            <Rating
              ...
              emptyIcon={
                <StarBorderIcon
                  style={{ color: "#ffffff7c", fontSize: "30px" }}
                />
              }
          ...
          <div className="mt-[24px]">
            <TextFieldArea
              ...
              fontSize="14px"
              borderRadius={props.square ? "0px" : "8px"}
              labelStyle='text-white bg-[rgba(255, 255, 255, 0.1)]'
            />
          </div>
