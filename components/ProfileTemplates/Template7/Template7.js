...
const Template7 = (props) => {props = useDefaultProps(props);
  console.log("B2T7");
  // profile is rounded or square
  const square = props.square;

  // Button Component Styling
  const buttonStyle = `bg-[#FFFFFF] text-[#121212] shadow-[4px_4px_0px_0px_#121212] hover:shadow-none duration-200 border border-[#121212] font-bold mb-1 Plus-Jakarta-Sans-font-div hover:cursor-pointer ${
  ...
  const customLinkStyle = {
    linkMainBg: `${
      props.blur
        ? "bg-[rgba(0,0,0,0.20)] backdrop-blur-[18px]"
        : 
        "bg-white"
    } ${square ? "rounded-[0px]" : "rounded-[20px]"}`,
    linkBg: {
