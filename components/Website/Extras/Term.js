...
const Term = () => {
  ...
  return (
    <div className="mb-[50px] xsm2:mx-[20px] break-all mx-[10px] flex text-wrap flex-col xsm2:gap-[10px] gap-[5px]">
      <h1 className="text-[22px] font-[600] ">Term and Conditions</h1>
      <div className="h-[4px] bg-slate-500 w-[40px] mb-[30px]"></div>
      <div className="gap-4 flex flex-col ">
        <p className="text-[16px] ">Last updated September 30th, 2023</p>
        <p className="font-bold text-[18px] ">AGREEMENT TO OUR LEGAL TERMS</p>
        <p>
          We are Tapop smart tech private limited , doing business as Qviq
          ("Company," "we," "us," "our"), a company registered in India at
          E-5/8, naharpur, rohini sector 7, New Delhi , Delhi 110085.
        </p>
        <p>
          We operate the website http://Www.qviq.io (the "Site"), as well as any
          other related products and services that refer or link to these legal
          terms (the "Legal Terms") (collectively, the "Services").
        </p>
        <p>
          Qviq is a digital platform that enables the users to create Qviqsites
          which are a form of personal websites that can be created instantly
          without having any technical or design skills and can be managed
          without any hassle or complexity. Qviqsites then can be shared through
          our qviq NFC smart cards, qr code or Qviqsite domain.
        </p>
        <p>
          You can contact us by phone at +919717023623, email at
          Support@qviq.io, or by mail to 2-A/3, Kundan mansion, Asaf ali road,
          Central Delhi 110002, Delhi, Delhi 110002, India.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and Tapop
          smart tech private limited , concerning your access to and use of the
        ...
        <p>
          ...
          upon posting or notifying you by Noreply@qviq.io, as stated in the
      ...
      <div className="gap-4 flex flex-col mt-4 ">
        ...
        <ul type="a" className="font-bold ml-8">
          <li>OUR SERVICES</li>
      ...
      <div className="my-7 flex flex-col gap-4 ">
        <p className="font-bold text-[18px]">1. OUR SERVICES</p>
        <p>
        ...
        <p className="font-bold text-[18px]">2. INTELLECTUAL PROPERTY RIGHTS</p>
        <p className="font-bold">Our intellectual property</p>
        <p>
        ...
        <p className="font-bold">Your use of our Services</p>
        <p>
        ...
        <p>
          ...
          please address your request to: Support@qviq.io. If we ever grant you
        ...
        <p className="font-bold">Your submissions and contributions</p>
        <p>
        ...
        <p>
          ...
          transmit, publish, distribute, or broadcast content and Termly
          https://app.termly.io/dashboard/website/0a9a4de9-d8ad-4285-9481-f5e...
          2 of 11 10/05/23, 20:01 materials to us or through the Services,
        ...
        <p>
          ...
          works, your Contributions, and to sublicensethe licenses granted in
        ...
        <p className="font-bold"> Copyright infringement</p>
        <p>
        ...
        <p className="font-bold text-[18px]">3. USER REPRESENTATIONS</p>
        <p>
        ...
        <p className="font-bold text-[18px]">4. USER REGISTRATION</p>
        <p>
        ...
        <p className="font-bold text-[18px]">5. PURCHASES AND PAYMENT</p>
        ...
        <p className="font-bold text-[18px]">6. FREE TRIAL</p>
        <p>
        ...
        <p className="font-bold text-[18px]">7. CANCELLATION</p>
        <p>
          ...
          with our Services, please email us at Support@qviq.io or call us at
          +919717023623.
        </p>
        <p className="font-bold text-[18px] ">8. PROHIBITED ACTIVITIES</p>
        <p>
        ...
        <ul className="ml-6">
          ...
          <li>
            ...
            send Termly
            https://app.termly.io/dashboard/website/0a9a4de9-d8ad-4285-9481-f5e...
            4 of 11 10/05/23, 20:01 comments or messages, or using any data
          ...
          <li>
            Uploading any offensive, abusive, disturbing or pornographic content
          </li>
          <li>
            Acting as anyone or creating a false profile that is representing
            any public figure or general.
          </li>
          <li>Adding any false commissions</li>
          <li>
            Creating a profile to sell or promote any illegal services or
            products
          </li>
          <li>Creating profile to spread false information</li>
        </ul>
        ...
        <p className="font-bold text-[18px]">10. CONTRIBUTION LICENSE</p>
        <p>
        ...
        <p className="font-bold text-[18px]">11. GUIDELINES FOR REVIEWS</p>
        <p>
        ...
        <p className="font-bold text-[18px]">12. SOCIAL MEDIA</p>
        <p>
          ...
          third-party service provider of the Termly
          https://app.termly.io/dashboard/website/0a9a4de9-d8ad-4285-9481-f5e...
          6 of 11 10/05/23, 20:01 Third-Party Account. By granting us access to
          ...
          additional information to the extent you arenotified when you link
        ...
        <p>
          ...
          privacy practices, or other policies of or contained in the Third-
        ...
        <p className="font-bold text-[18px]">14. SERVICES MANAGEMENT</p>
        <p>
        ...
        <p className="font-bold text-[18px]">15. PRIVACY POLICY</p>
        <p>
        ...
        <p className="font-bold text-[18px]">16. COPYRIGHT INFRINGEMENTS</p>
        <p>
          We respect the intellectual property rights of others. If you believe
          that any material available on or through the Services infringes upon
        ...
        <p className="font-bold text-[18px]">17. TERM AND TERMINATION</p>
        <p>
        ...
        <p className="font-bold text-[18px]">19. GOVERNING LAW</p>
        <p>
          These Legal Terms shall be governed by and defined following the laws
          of India. Tapop smart tech private limited and yourself irrevocably
        ...
        <p className="font-bold text-[18px]">20. DISPUTE RESOLUTION</p>
        <p className="font-bold">Informal Negotiations</p>
        <p>
        ...
        <p>
          ...
          be two (2). The seat, or legal place, or arbitration shall be Delhi,
        ...
        <p className="font-bold text-[18px]">21. CORRECTIONS</p>
        <p>
        ...
        <p className="font-bold text-[18px]">22. DISCLAIMER</p>
        <p>
        ...
        <p className="font-bold text-[18px]">23. LIMITATIONS OF LIABILITY</p>
        <p>
          ...
          OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE THREE (3) MONTH
          PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR INDIAN RUPEES . CERTAIN
        ...
        <p className="font-bold text-[18px]">24. INDEMNIFICATION</p>
        <p>
        ...
        <p className="font-bold text-[18px]">25. USER DATA</p>
        <p>
        ...
        <p className="font-bold text-[18px]">27. MISCELLANEOUS</p>
        <p>
        ...
        <p className="font-bold text-[18px]">28. CONTACT US</p>
        <p>
          In order to resolve a complaint regarding the Services or to receive
          further information regarding use of the Services, please contact us
          at: Tapop smart tech private limited 2-A/3, Kundan mansion,Asaf ali
          road,Central Delhi 110002 Delhi, Delhi 110002 India Phone:
          +919717023623 support@qviq.io These terms of use were created using
          Termly's Terms and Conditions
        </p>
      </div>
    </div>
  );
