...
const Privacy = () => {
  ...
  return (
    <div className="mb-[50px] xsm2:mx-[20px] mx-[10px]  flex text-wrap flex-col xsm2:gap-[10px] gap-[5px]">
      <p className="text-[22px] font-[600] ">Privacy Policy</p>
      <div className="h-[4px] bg-slate-500 w-[40px] mb-[30px]"></div>
      <p className=" ">Last updated: October 05, 2023</p>
      <div className="gap-2">
        <p className="mt-2">
      ...
      <div className="mt-4 gap-3">
        <h2 className="text-[30px] font-[800]  ">
          {" "}
          Interpretation and Definitions
        </h2>
        <p className="text-[18px] font-bold ">Interpretation</p>
        <p>
        ...
        <p className="text-[18px] font-bold ">Definitions</p>
        ...
        <div className="ml-[20px]">
          ...
          <p>
            ...
            Tapop smart tech private limited, 2-A/3, Kundan mansion, asaf ali
            road, Daryaganj, central Delhi-110002
          </p>
          <p>
            {" "}
          ...
          <p>
            {" "}
            <span className="font-bold">Country</span> refers to: Delhi, India.
          </p>
          <p>
            {" "}
          ...
          <p>
            ...
            User can log in or create an account to use the Service. Usage Data
          ...
          <p>
            {" "}
            <span className="font-bold"> Website </span> refers to Qviq,
            accessible from www.qviq.io
          </p>
          <p>
            {" "}
      ...
      <div className="mt-4 gap-4">
        ...
        <h3 className="text-[25px] font-bold ">Types of Data Collected</h3>
        <p className="text-[18px] font-bold ">Personal Data</p>
        <p>
        ...
        <p>
          ...
          Province, Associate you with your personal info on Google, See your personal info 
          (including any personal info you've made publicly available such as full name,profile picture,gender,preferred languages), See your primary Google Account email address.
        </p>
        <p>
        Qviq use and transfer of information received from Google APIs to any other app will adhere to{" "}
          <a
            className="underline"
        ...
        <p className="text-[18px] font-bold ">Usage Data</p>
        ...
        <p className="text-[18px] font-bold my-2">Usage Data</p>
        <p>
        ...
        <p className="text-[18px] font-bold my-2">
        ...
        <div className="flex ml-4">
          ...
          <p>
            <span className="font-bold">Web Beacons. </span> A Certain sections
      ...
      <div className="ml-8">
        ...
        <p className="text-[18px] font-bold ">Functionality Cookies</p>
        <p> Type: Persistent Cookies</p>
        <p>Administered by: Us</p>
        <p>
      ...
      <div>
        <p className="text-[20px] font-bold mt-8 ">Use of Your Personal Data</p>
        ...
        <div className="ml-8 gap-5 ">
          ...
          <p>
            <span className="font-bold">To provide You with news,</span> special
      ...
      <div className="gap-6">
        ...
        <p className="text-[20px] font-bold mt-4">Delete Your Personal Data</p>
        <p>
        ...
        <p className="text-[26px] font-bold mt-3">Business Transactions</p>
        <p>
        ...
        <p className="text-[26px] font-bold mt-3">Law enforcement</p>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <p className="text-[26px] font-bold mt-3">Other legal requirements</p>
        <p>
        ...
        <div className="flex ml-8 ">
          ...
          <p className="mt-[6px]">Comply with a legal obligation</p>
        </div>
        <div className="flex ml-8 ">
          <span>
            <li></li>
        ...
        <div className="flex ml-8 ">
          ...
          <p className="mt-[6px]">Protect against legal liability</p>
        </div>
      </div>
      ...
      <div className="mt-8">
        <p className="text-[30px] font-bold ">Children's Privacy</p>
      ...
      <div className="mt-8">
        <p className="text-[30px] font-bold ">Links to Other Websites</p>
      ...
      <div className="mt-8">
        <p className="text-[30px] font-bold ">Changes to this Privacy Policy</p>
      ...
      <div className="my-8">
        ...
        <p>By email: support@qviq.io</p>
        <p>By visiting this page on our website: https://qviq.io/contact</p>
        <p>By phone number: +919717023623</p>
      </div>
    </div>
  );
};
