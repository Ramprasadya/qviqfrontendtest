...
import text from "@/components/Images/404.png";
import errorimg from "@/components/Images/errorimg.png";
      ...
      try {
        if(hostname != "localhost:3000"){
          const response = await axios.post(
            `${serverUrl}/errorReporting/errorOccured`,
            {
              path:"layout",
    ...
    <html>
      <body>
        ...
        >
          ...
          <div className=" bg-white z-50 mx-4 flex flex-col justify-center p-[20px] md:ml-[20px] md:mr-[20px] md:rounded-[40px] items-center lg:mx-[60px]  lg:mb-[84px] lg:pb-[80px] lg:rounded-[40px] rounded-[40px]">
            <div className="flex justify-center  md:mt-[80px] xl:ml-[60px] lg:mb-[39px]  xl:mr-[15px] flex-col-reverse lg:flex-row items-center">
              <div className="flex flex-col justify-center lg:ml-[25px] lg:justify-normal lg:items-start items-center  ">
                ...
                <p className="xsm:text-[12px] lg:text-[24px]  lg:text-left mb-[55px] text-center font-semibold color-[#1A1A1A] xl:text-[24px] md:text-[15px] sm:text-[16px]">
                  We're sorry, but the page got some error.
                </p>

                <div className="hidden md:w-[340px] lg:w-[356px] lg:block sm:w-[356px]  h-[48px] xsm:w-[270px]">
                  <p className="xsm:text-[12px] lg:text-[24px]  lg:text-left mb-[55px] text-center font-semibold color-[#1A1A1A] xl:text-[24px] md:text-[15px] sm:text-[16px]">Navigating Back...</p>
                </div>
              </div>
